...
const CREDITS = [
    {
        ...
        rows: [['Joncarlo Benton', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Joncarlo Benton', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Joncarlo Benton', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Joncarlo Benton'}
        >
            <div
